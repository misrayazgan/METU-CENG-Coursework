...
SoSeparator* Painter::drawEdge(Mesh* mesh, float *v1coords, float *v2coords, float *color, bool isThickEdge)
{
...
SoSeparator* Painter::getSphereSepByCoord(Mesh* mesh, float *coords, float radius)
{
	SoSeparator* sphereSep = new SoSeparator();

	SoTransform* tra = new SoTransform();
	tra->translation.setValue(coords[0], coords[1], coords[2]);
	sphereSep->addChild(tra);
