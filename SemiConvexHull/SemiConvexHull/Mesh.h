...
private:
	...
	void parseString(string &src, string &dest);
public:
	vector< Vertex* > verts;
	...
	int findEdgeByVertices(int v1, int v2);
	void addTriangleWithoutEdge(int v1, int v2, int v3);
	vector<int> findCommonTriangles(int v1, int v2);
	int getThirdVertexOfTriangle(int t, int v1, int v2);
	int getTriangleByVertices(int v1, int v2, int v3);
};
